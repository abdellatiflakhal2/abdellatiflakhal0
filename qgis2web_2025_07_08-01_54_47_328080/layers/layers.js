...
var lyr__2 = new ol.layer.Vector({
                ...
                style: style__2,
                popuplayertitle: 'خريطة المغرب',
                interactive: true,
                title: '<img src="styles/legend/_2.png" /> خريطة المغرب'
            });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_2_1.setVisible(true);lyr__2.setVisible(true);lyr_1_3.setVisible(true);lyr__4.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_2_1,lyr__2,lyr_1_3,lyr__4];
...
lyr_2_1.set('fieldLabels', {'fid': 'no label', 'REGION': 'no label', 'NOM_REGION': 'no label', 'centre_ré': 'no label', });
lyr__2.set('fieldLabels', {'fid': 'no label', 'REGION': 'no label', 'NOM_REGION': 'header label - visible with data', 'centre_ré': 'header label - visible with data', });
lyr_1_3.set('fieldLabels', {'fid': 'no label', 'Airport_Na': 'no label', 'Latitude': 'no label', 'Longitude': 'no label', 'Google_Map': 'no label', });
lyr__4.set('fieldLabels', {'fid': 'header label - visible with data', 'Airport_Na': 'header label - visible with data', 'Latitude': 'header label - visible with data', 'Longitude': 'header label - visible with data', 'Google_Map': 'header label - visible with data', });
